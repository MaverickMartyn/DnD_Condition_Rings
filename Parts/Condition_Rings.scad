// Rings
module create_ring_grid(ring_texts, diameter, font_family, font_style, font_size, spacing, thickness, text_step_height, letter_separation, text_ring_spacing, direction, use_backplate, backplate_thickness) {
  radius = diameter / 2;
